...
Sub Main
    ...
    Dim fso,file1,line,logfile,params,ipaddr,ussername,password
    ...
    DO While file1.AtEndOfStream <> True
	   ...
	   If params(4) = 0	Then
			...
			Login_Telnet ipaddr,username,password
...
Function Login_Telnet (ipaddress,username,password)
...
Function PrivilegeLevel(str1,ipaddress)
       ...
       logfile = "d:\logfile\" & ipaddress & HN & "_%Y.%M.%D_%h.%m.%s_.log"
